# pip install websocket-client pydub pynput pyaudio
import base64
import json
import os
import threading
...
class RealtimeClient:
            ...
            json.dumps(
                {
                    ...
                    "session": {
                        ...
                        "turn_detection": None,
                        "instructions": "You are listening to the conversation/ lecture, NOT actively participating in the conversation. Listen carefully to audio and identify difficult or unfamiliar English words. Always, only provide very concise information.",
                    },
                }
            )
        )
    ...
    def stream_audio(self):
        """Stream audio file to API + play locally"""
        ...
        print(
            f"Playing & streaming {len(audio)/1000:.1f}s... Press SPACE for descriptions, ESC to quit"
        )
    ...
    def request_description(self):
        """Spacebar pressed - request description"""
